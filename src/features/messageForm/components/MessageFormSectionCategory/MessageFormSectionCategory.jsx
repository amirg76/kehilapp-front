  ...
  return (
    <>
      ...
      <div className="relative w-1/2 mb-5">
        <select className="block appearance-none w-full bg-white text-gray-400 border border-gray-300 hover:border-gray-500 py-2 px-4 rounded-md leading-tight focus:outline-none focus:shadow-outline">
