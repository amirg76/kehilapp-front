    ...
    return (
        <div className={containerStyle}>
            ...
            <select name={name} value={value} onChange={onChange} onBlur={onBlur}
                className={`appearance-none w-full bg-white focus:shadow-outline border border-gray-300 
                px-3 py-2 rounded-md focus:outline-none focus:border-primary-700 ${!value && 'text-gray-400'} ${style}`} {...otherProps}>
